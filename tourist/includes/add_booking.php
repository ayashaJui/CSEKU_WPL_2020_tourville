        ...
        if(isset($_GET['package_id'])){
            if(isset($_POST['book'])){
                ...
                if($check_in == '' || $persons == '' || $firstname == '' || $lastname == '' || $email == ''){
                    ...
                    $stmt = $pdo->prepare('INSERT INTO bookings(package_id, tourist_id, agency_id, persons, check_in, tourist_firstname, tourist_lastname, tourist_email, tourist_contact, enquiry_msg, booking_status, date) VALUES(:package_id, :tourist_id, :agency_id, :persons, :check_in, :tourist_firstname, :tourist_lastname, :tourist_email, :tourist_contact, :enquiry_msg, :booking_status, :date)');
